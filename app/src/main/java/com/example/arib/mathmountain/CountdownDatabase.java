 ...
 */
public class CountdownDatabase extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION   = 2;
    private static final String DATABASE_NAME   = "highScoresLevel";
    private static final String TABLE_TEAMS     = "highscoresLevel";
